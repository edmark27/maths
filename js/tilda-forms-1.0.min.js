...
break;case 'url':regExp=/^((https?|ftp):\/\/)?[a-zA-ZС‘Р°-СЏРЃРђ-РЇРЃС‘Г¤Г¶ГјГ„Г–ГњГџГЁГ©Г»ЕџГ§0-9][a-zA-ZС‘Р°-СЏРЃРђ-РЇРЃС‘Г¤Г¶ГјГ„Г–ГњГџГЁГ©Г»ЕџГ§0-9\.\-]{0,253}\.[a-zA-ZС‘Р°-СЏРЃРђ-РЇ]{2,10}\/?$/;if(val.length>0){str=val.split('//');if(str&&str.length>1){str=str[1]}else{str=str[0]}
